...
(g_direct_pointed,_,_) = point_grammar(g_direct)
...
(g_disappearing_class_pointed,_,_) = point_grammar(g_disappearing_class)
...
(g_complex_dependance_pointed,_,_) = point_grammar(g_complex_dependance)
